...
🔐 1. Hardened Ingress Layer (NGINX)
...
🖥️ 2. Open WebUI — User Interface & API Orchestration
...
🧠 3. Ollama Model Server — Local Model Execution
...
curl -v https://llm.cantaloop.dk/api/v1/chat/completions \
  ...
  -H "Authorization: Bearer sk-18a68fa9a3c54366af92e2e7778e68c3" \
  -d '{
    "model": "llama3.2:1b",
    "messages": [
